...
#ifndef INCLUDE_EXADG_CONVECTION_DIFFUSION_POSTPROCESSOR_LINE_PLOT_CALCULATION_H_
#define INCLUDE_EXADG_CONVECTION_DIFFUSION_POSTPROCESSOR_LINE_PLOT_CALCULATION_H_
...
private:
  ...
  dealii::SmartPointer<dealii::DoFHandler<dim> const> dof_handler_eddy_viscosity;
